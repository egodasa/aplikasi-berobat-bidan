<template>
  <v-card>
    ...
    <v-card-actions>
      ...
      <v-btn append:boolean="true" :to="{name: 'showJsatuan'}" class="normal">Daftar Jenis Satuan</v-btn>
    </v-card-actions>
  </v-card>
</template>
<script>
  ...
  data () {
    return {
      ...
      form: {
        ...
        // URL for save data
        saveUrl: "http://localhost:3333/api/v1/jenis-satuan/" + this.$route.params.id,
